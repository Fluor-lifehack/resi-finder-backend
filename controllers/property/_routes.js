...
router.get("/lasted-properties", property.getLatestProperty);
router.post("/search", property.getRechercheResult);
router.get("/lasted-six-properties", property.getSixLatestProperty);
router.get("/featured-properties", property.getFeaturedProperties);
router.get("/get-properties-by-ville", property.getPropertiesByVille);
